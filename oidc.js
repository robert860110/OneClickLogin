...
OpenIDConnect.prototype.sendCode = function() {
    var self = this;

    return [self.use({ policies: { loggedIn: false }, models: 'smscode' }),
                        ...
                        req.model.smscode.create({ phone_number: phone, password: newPassword }, function(err, smscode) {
                            if (err || !smscode) {
                                ...
                                twilioClient.sms.messages.create({
                                    to: phone,
                                    from: '+1 408-359-4157',
                                    body: 'Your confirmation code is:' + newPassword + '. (Valid for 10 mins)'
